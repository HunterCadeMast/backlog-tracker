...
const Backlog = () => {
    ...
    return (
        <div className = "bg-main-compliment p-16 min-h-screen">
            <div className = "sticky top-16 z-50 pb-8 flex flex-wrap gap-4 items-center">
                            ...
                            <div className = "mt-4 space-y-6">
                                {total_logs.map(log => (
                                    <RandomColor key = {log.id} element = "bg">
                                        <Link href = {`/games/${log.game.id}`} className = "p-4 bg-ui rounded-lg outline-4 outline-white flex items-center gap-5 transition">
                                                    ...
                                                    <div className = "space-y-3">
                                                        {log.start_date && (
                                                            <>
                                                                ...
                                                                <p className = "indent-5">{log.start_date}</p>
                                                            </>
                                                        )}
                                                        {log.completion_date && (
                                                            <>
                                                                <h1 className = "text-xl font-main-title">Completion Date:</h1>
                                                                <p className = "indent-5">{log.completion_date}</p>
                                                            </>
                                                        )}
                                                        <h1 className = "text-xl font-main-title">100% Completion:</h1>
                                                        <p className = "indent-5">{log.full_completion ? "Yes" : "No"}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </Link>
