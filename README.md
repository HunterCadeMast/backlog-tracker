...
<h3 align="center">Full Stack Web App</h3>
  ...
  <p align="center">
    ...
    <br />
    <br />
    <a href="https://github.com/huntercademast/backlog-tracker">View Demo</a>
    &middot;
...
1. Get a free API Key at [https://gaminglogjam.com](https://gaminglogjam.com)
2. Clone the repo
   ```sh
...
5. Change git remote url to avoid accidental pushes to base project
   ```sh
   git remote set-url origin huntercademast/backlog-tracker
...
_For more examples, please refer to the [Documentation](https://gaminglogjam.com)_
...
See the [open issues](https://github.com/huntercademast/backlog-tracker/issues) for a full list of proposed features (and known issues).
...
<a href="https://github.com/huntercademast/backlog-tracker/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=huntercademast/backlog-tracker" alt="contrib.rocks image" />
</a>
